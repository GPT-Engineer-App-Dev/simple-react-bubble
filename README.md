...
**Project**: simple-react-bubble 

**URL**: https://run.gptengineer.app/projects/REPLACE_WITH_PROJECT_ID/improve

**Description**: Make the simplest react app possible 
...
```sh
git clone https://github.com/GPT-Engineer-App-Dev/simple-react-bubble.git
cd simple-react-bubble
npm i
